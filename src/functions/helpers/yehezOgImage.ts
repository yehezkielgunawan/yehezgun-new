export const yehezOgImage = (text: string, isArticle: boolean) => {
  if (isArticle) {
    return `https://yehez-og-image.yehezgun.com/${text}.png?theme=dark&md=1&fontSize=75px&images=https%3A%2F%2Fres.cloudinary.com%2Fyehez%2Fimage%2Fupload%2Fv1630902976%2FAssassination_Classroom_-_Koro-sensei_smiling_head_fwpndi.svg&widths=300&heights=300`;
  }
